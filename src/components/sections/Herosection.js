    ...
    >
      <div className="container">
        <div className="intro">
          ...
          <h1 className="mb-2 mt-0">Mohammad Abdul Mohaiman</h1>
          <p>
            I'm a{" "}
            <Typed
              strings={[
          ...
          <ul className="social-icons light list-inline mb-0 mt-4">
            <li className="list-inline-item">
              <a href="https://github.com/m4mohaiman" target="_blank" rel="noopener noreferrer">
                <i className="fab fa-github"></i>
              </a>
            </li>
            <li className="list-inline-item">
              <a href="https://twitter.com/mohaiman_dev" target="_blank" rel="noopener noreferrer">
                <i className="fab fa-twitter"></i>
              </a>
            </li>
            <li className="list-inline-item">
              <a href="https://www.behance.net/mohaiman" target="_blank" rel="noopener noreferrer">
                <i className="fab fa-behance"></i>
              </a>
            </li>
            <li className="list-inline-item">
              <a href="https://www.linkedin.com/in/mohaiman/" target="_blank" rel="noopener noreferrer">
                <i className="fab fa-linkedin"></i>
              </a>
            </li>
            <li className="list-inline-item">
              <a href="https://codepen.io/mohaiman" target="_blank" rel="noopener noreferrer">
          ...
          <div className="mt-4">
            <a
              ...
              href="https://drive.google.com/file/d/1-uoDlOwxtn7iknVtFuXfiN1-KK1R-DdS/view?usp=sharing"
